...
自选代币助手，实时查看您关注的代币，助您快速获取实时数据。

可以用来查看您的自选代币的实时估值情况，可以自由的增减自选代币。您的自选代币数据会跟随账号同步。

## 介绍

买了代币后，一直想找一款 pc 端的 chrome 扩展插件，毕竟股票的交易时间都是在工作日进行的，可惜找不到，便打算自己写一个，忍痛花费 5 美刀上架扩展商店。扩展的形式很适合上班族，不用打开网站，仅以小窗口的形式展示，不会引起 BOSS 的注意，方便上班摸鱼。

首先输入代币代码添加代币，涨跌幅信息和收益信息可以以角标的形式展示在浏览器中，更加简便直观。可以在设置中单独开启显示份额与收益选项，在编辑中输入持有的份额，可以计算出每个代币的实时估值与收益，以及总收益。

## 主要功能

- 实时角标提醒
- 单个代币特别关注
- 角标内容自定义，单个与全部代币，收益额与收益率
- 支持标准与暗色两种主题
- 代币列表与配置信息支持导入与导出
- 智能判断节假日，切换休市状态
- 支持设置份额或金额，查看当日估值收益
...
- 支持手动加仓减仓功能。
- 编辑代币信息时支持份额金额二选一输入。
- 修复代币累计收益曲线异常问题、代币持有收益率计算问题。
- 其他问题修复与优化。

### v2.5.1

- 修复代币信息的 Excel 导入导出功能。

### v2.5.0

- 支持代币信息的 Excel 导入导出功能。
- 支持锁定并保持代币的排序方式。
...
- 调整代币接口，支持当日实际净值，已更新的代币会有 √ 提示。
- 角标支持自定义功能，单个、全部、收益率、收益额，随心所欲。
- 支持查看历史更新日志功能。

### v1.8.0

- 新增查看代币详情功能，点击代币名称即可查看估值图、走势图等相关信息。
- 新增代币配置信息的导入导出功能。
- 修复页面布局中的 bug。
...
- 顶部代币信息支持动态修改。
- 暂停实时更新功能改为全局生效。
- 修复删除特别关注的代币后，脚本还实时更新的异常。

### v1.6.0

- 解决代币添加后无法显示、代币丢失等异常问题。
- 增加按类别排序功能。
- 增加拖拽排序功能。
- 添加代币时增加搜索与多选功能。
